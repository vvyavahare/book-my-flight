...
export default function BookingConfirmationPage({
  ...
  return (
    <div className="mx-auto mt-6 max-w-2xl">
      <div className="rounded-2xl border border-white/60 bg-white/85 p-8 shadow-xl shadow-emerald-100 backdrop-blur">
        <div className="flex items-center gap-3">
          <span className="grid h-11 w-11 place-items-center rounded-full bg-emerald-100 text-2xl text-emerald-600">
            ✓
          </span>
          <div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 rounded-xl bg-slate-50/70 p-4 text-sm">
          ...
          />
          <Info label="Contact" value={booking.contactEmail} span />
          <Info
            label="Total paid"
